...
CKEDITOR.plugins.add('IBEPhoto', {
  requires: 'dialog',
  // jscs:disable maximumLineLength
  lang: 'en,zh,zh-cn', // %REMOVE_LINE_CORE%
  // jscs:enable maximumLineLength
  icons: 'IBEPhoto', // %REMOVE_LINE_CORE%
  hidpi: true, // %REMOVE_LINE_CORE%
  init: function (editor) {
    editor.config.smiley_path = editor.config.smiley_path || ( this.path + 'images/' );
    editor.addCommand('IBEPhoto', new CKEDITOR.dialogCommand('IBEPhoto', {
      allowedContent: 'img[alt,height,!src,title,width]',
      requiredContent: 'img'
    }));
    editor.ui.addButton && editor.ui.addButton('IBEPhoto', {
      label: editor.lang.IBEPhoto.toolbar,
      command: 'IBEPhoto',
      toolbar: 'insert,50'
    });
    CKEDITOR.dialog.add('IBEPhoto', this.path + 'dialogs/IBEPhoto.js');
  }
});
